...
export const cancelImportRequest = (id: number) =>
  axios.patch(`${BASE}/import-requests/${id}/cancel`, {}, { headers: getHeaders() });
...
// ─── Disposals ──────────────────────────────────────────────────────
export const getDisposalHistory = () =>
  axios.get(`${BASE}/disposals/history`, { headers: getHeaders() });
